...
const baseURL: string = 'http://localhost:5000';
  ...
  export const getCommentByPostId = async(id: string): Promise<CommentInterface[]> => {
    return await axios.get(`${baseURL}/comments/${id}`)
  }

  export const addComment = async(object: AddCommentFunctionInterface): Promise<CommentInterface> => {
    return await axios.post(`${baseURL}/comments`,object)
  }

 export const addReply = async(object: AddReplyInterface): Promise<CommentInterface> => {
